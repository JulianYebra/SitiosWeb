...
class JSONBinClient {
    constructor() {
        ...
        this.apiKey = '$2a$10$u3.2k9kq/q5T8DjJM2wpi.Smyebu1OZOWmYEA6ta7E5NvQNSPGIhq';
        this.binId = '68929a10ae596e708fc29f09';
    }
// const BIN_ID = '68929a10ae596e708fc29f09';
// const API_KEY = '$2a$10$u3.2k9kq/q5T8DjJM2wpi.Smyebu1OZOWmYEA6ta7E5NvQNSPGIhq';

    /**
     * Establece la API Key
     * @param {string} apiKey - Tu API Key de JSONBin.io
     * @param {string} binId - Tu API Key de JSONBin.io
     */
    setApiKey(apiKey) {
        this.apiKey = apiKey;
